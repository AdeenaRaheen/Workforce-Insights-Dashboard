...
## Key Features
- Interactive filters for slicing data by department, tenure, and location.
- Key Performance Indicators (KPIs) to track employee turnover and satisfaction.
- Visualizations that highlight demographic trends and performance distribution.
